  ...
  <body id="page-top">
    <div id="wrapper">
      <div id="content-wrapper">
        <nav class="navbar navbar-expand-sm mb-5 bg-white navbar-light shadow">
          <a class="text-decoration-none ml-2" href="departures.php">
            <img class="mr-2" src="static/images/logo-54x64.png" alt="LLAS logo" width="54" height="64">
            <i class="fas fa-redo fa-sm fa-fw ml-1"></i>
            <span>Refresh</span>
          </a>
        </nav>
        ...
        <div class="container-fluid pb-1">
          ...
          <div class="card mb-5 shadow">
            <div class="card-header py-3">
              <h2 class="h6 mb-0 font-weight-bold">Departures</h2>
            </div>
